        ...
        <>
            ...
            >
                ...
                <div className="h-16 px-5 flex items-center justify-between border-b border-slate-200/80 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-xs">
                    ...
                    >
                        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-brand-600 via-brand-700 to-sky-600 flex items-center justify-center text-white font-bold text-lg shadow-sm shadow-brand-500/20 group-hover:scale-105 transition-transform">
                            C
                        </div>
                        <div>
                        ...
                        return (
                            <div key={item.id} className="space-y-0.5">
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all group cursor-pointer ${isActive
