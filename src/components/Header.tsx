      ...
      <div className="h-full px-4 sm:px-6 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2 -ml-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg lg:hidden focus:ring-2 focus:ring-indigo-500 cursor-pointer"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-md text-slate-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-indigo-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
              title="Ir al inicio"
            >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative flex items-center gap-2" ref={dropdownRef} id="student-selector-container">
            ...
            <button
              ...
              className="flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded-xl border border-indigo-200 dark:border-indigo-900/60 bg-indigo-50/70 dark:bg-indigo-950/40 hover:bg-indigo-100/70 dark:hover:bg-indigo-950/70 text-slate-800 dark:text-slate-100 transition-colors cursor-pointer shadow-2xs"
            ...
            >
              ...
              <div className="text-left">
                <span className="text-xs font-medium text-indigo-950 dark:text-indigo-200 block leading-tight">
                  {currentStudent.name}
                </span>
              </div>
              <ChevronDown
                className={`w-4 h-4 text-indigo-600 dark:text-indigo-400 transition-transform ${
              ...
              >
                ...
                {students.map((student) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2 text-left hover:bg-slate-50 dark:hover:bg-slate-800/60 transition-colors cursor-pointer ${
                ...
                <div className="p-2 border-t border-slate-100 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/60 mt-1">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-1.5 px-2 rounded-lg text-[11px] font-semibold text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                  >
