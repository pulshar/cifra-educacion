                    ...
                    <td className="px-5 py-4 text-right">
                      {!rec.justified && rec.type === 'ausencia_sin_justificar' ? (
                        <button
                          ...
                          className="px-3 py-1.5 text-xs font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/60 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 rounded-xl transition-colors cursor-pointer"
                        >
                          Justificar ahora
                        </button>
                      ) : (
