          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-lg bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 flex items-center justify-center">
              ...
              <button
                ...
                className="text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 flex items-center gap-1 cursor-pointer mt-1.5"
              >
                ...
                studentNotifications.slice(0, 3).map((notif) => (
                  <div
                    ...
                    className={`p-3 rounded-xl border transition-all cursor-pointer ${notif.read
                      ...
                      : 'bg-indigo-50/40 dark:bg-indigo-950/20 border-indigo-200/80 dark:border-indigo-900/40 hover:bg-indigo-50/70'
                      }`}
                  >
      ...
      case 'mensajes':
        return (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-lg bg-sky-50 dark:bg-sky-950/60 text-sky-600 dark:text-sky-400 flex items-center justify-center">
              ...
              <button
                ...
                className="text-xs font-semibold text-sky-600 dark:text-sky-400 hover:text-sky-700 flex items-center gap-1 cursor-pointer mt-1.5"
              >
      ...
      case 'circulares':
        return (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-lg bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 flex items-center justify-center">
              ...
              <button
                ...
                className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 flex items-center gap-1 cursor-pointer mt-1.5"
              >
      ...
      case 'eventos_proximos':
        return (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-lg bg-amber-50 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400 flex items-center justify-center">
              ...
              <button
                ...
                className="text-xs font-semibold text-amber-600 dark:text-amber-400 hover:text-amber-700 flex items-center gap-1 cursor-pointer mt-1.5"
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                {next7DaysEvents.map((ev) => (
                  <div
                    ...
                    className="p-3.5 rounded-xl border border-slate-200/70 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-800/40 hover:border-amber-400 dark:hover:border-amber-600 transition-all cursor-pointer group"
                  >
      ...
      case 'proximas_clases':
        return (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-lg bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 flex items-center justify-center">
              ...
              <button
                ...
                onClick={() => navigateTo('agenda')}
                className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 flex items-center gap-1 cursor-pointer mt-1.5"
              >
                <span>{t.dashboard.viewAgenda}</span>
                <ChevronRight className="w-3.5 h-3.5" />
              </button>
                ...
                todayClasses.map((cls) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-14 text-center py-1 px-1.5 rounded-lg bg-blue-100/70 dark:bg-blue-950/50 text-blue-800 dark:text-blue-300 font-mono text-[11px] font-bold">
                        {cls.startTime}
                      </div>
                      <div>
      ...
      case 'ultima_factura':
        return (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-lg bg-violet-50 dark:bg-violet-950/60 text-violet-600 dark:text-violet-400 flex items-center justify-center">
              ...
              <button
                ...
                className="text-xs font-semibold text-violet-600 dark:text-violet-400 hover:text-violet-700 flex items-center gap-1 cursor-pointer mt-1.5"
              >
            ...
            <div className="flex-1 flex flex-col justify-center">
              {!latestInvoice ? (
                ...
                <div
                  ...
                  className="p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-800/40 hover:border-violet-300 dark:hover:border-violet-700 transition-all cursor-pointer"
                >
                  <div className="flex items-center justify-between mb-2">
      ...
      case 'graficas_asistencia':
        return (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-2.5">
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-lg bg-teal-50 dark:bg-teal-950/60 text-teal-600 dark:text-teal-400 flex items-center justify-center">
              ...
              <button
                ...
                className="text-xs font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 flex items-center gap-1 cursor-pointer mt-1.5"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                <div className="w-10 h-10 shrink-0 hidden sm:flex rounded-xl bg-indigo-100 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 flex items-center justify-center font-bold">
  ...
  return (
    <div id="dashboard-view-container" className="space-y-6 pb-12">
      ...
      <div
        ...
        className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-indigo-900 via-indigo-800 to-slate-900 text-white shadow-md relative overflow-hidden"
      >
        <div className="relative z-10">
          <div className="flex flex-wrap items-center gap-2 text-indigo-200 text-xs font-medium mb-1">
            ...
            >
              ...
              <span className="text-[10px] text-indigo-200 font-normal">({currentStudent.school?.code || 'Oficial'})</span>
            </button>
          </div>
        ...
        <div className="absolute -right-10 -bottom-10 w-48 h-48 rounded-full bg-indigo-500/10 pointer-events-none" />
        <div className="absolute right-32 -top-10 w-32 h-32 rounded-full bg-sky-500/10 pointer-events-none" />
      </div>
      ...
      {activeModules.length === 0 ? (
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-10 text-center max-w-md mx-auto my-8 shadow-xs">
          ...
          <button
            ...
            onClick={() => navigateTo('configuracion', 'configurar_inicio')}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-xs transition-colors cursor-pointer"
          >
